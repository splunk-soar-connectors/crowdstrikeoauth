...
CROWDSTRIKE_CONNECTIVITY_TEST_ERR = "Test connectivity failed"
CROWDSTRIKE_CONNECTIVITY_ERR = "Error connecting to server"
CROWDSTRIKE_FROM_SERVER_ERR = "Error from Server, Status Code: {status}, Message: {message}"
CROWDSTRIKE_END_TIME_LT_START_TIME_ERR = "End time less than start time"
...
CROWDSTRIKE_UNSUPPORTED_HASH_TYPE_ERR = "Unsupported hash type"
CROWDSTRIKE_API_UNSUPPORTED_METHOD_ERR = "Unsupported method"
CROWDSTRIKE_SERVER_CONNECTIVITY_ERR = "Connection failed"
CROWDSTRIKE_JSON_PARSE_ERR = "Unable to parse reply as a Json, raw string reply: '{raw_text}'"
CROWDSTRIKE_FROM_SERVER_ERR = "API failed, Status code: {status}, Detail: {detail}"
CROWDSTRIKE_SUCC_SET_STATUS_ERR = "Successfully set status"
CROWDSTRIKE_NO_MORE_FEEDS_AVAILABLE = "No more feeds available"
CROWDSTRIKE_GETTING_EVENTS_MSG = "Getting maximum {max_events} events from id {lower_id} onwards (ids might not be contiguous)"
CROWDSTRIKE_CONNECTIVITY_ERR = "Error connecting to server"
CROWDSTRIKE_FROM_SERVER_ERR = "Error from Server, Status Code: {status}, Message: {message}"
CROWDSTRIKE_USING_BASE_URL_ERR = "Using base url: {base_url}"
CROWDSTRIKE_META_KEY_EMPTY_ERR = "Meta key empty or not present"
CROWDSTRIKE_RESOURCES_KEY_EMPTY_ERR = "Resources key empty or not present. Please try after sometime"
CROWDSTRIKE_DATAFEED_EMPTY_ERR = "Datafeed key empty or not present"
CROWDSTRIKE_SESSION_TOKEN_NOT_FOUND_ERR = "Session token, not found"
PAYLOAD_SECURITY_SUBMITTING_FILE_MSG = 'Submitting file/url to Falcon Sandbox'
CROWDSTRIKE_UNSUPPORTED_HASH_TYPE_ERR = "Unsupported hash type"
CROWDSTRIKE_EVENTS_FETCH_ERR = "Error occurred while fetching the DetectionSummaryEvents from the CrowdStrike server datafeed URL stream"
...
CROWDSTRIKE_UNAVAILABLE_MSG_ERR = "Error message unavailable. Please check the asset configuration and|or action parameters"
...
CROWDSTRIKEOAUTH_EMPTY_RESPONSE_ERR = "Status Code {code}. Empty response and no information in the header"
# endpoint
