...
CROWDSTRIKE_DEFAULT_TIMEOUT = 30
...
CROWDSTRIKE_CLIENT_SECRET = "client_secret"  # noqa: S105  # pragma: allowlist secret
CROWDSTRIKE_OAUTH_TOKEN_STRING = "oauth2_token"  # noqa: S105
CROWDSTRIKE_OAUTH_ACCESS_TOKEN_STRING = "access_token"  # noqa: S105
CROWDSTRIKE_OAUTH_ACCESS_TOKEN_IS_ENCRYPTED = "is_encrypted"  # noqa: S105
...
CROWDSTRIKE_JSON_PARSE_ERROR = (
    "Unable to parse reply as a Json, raw string reply: '{raw_text}'"
)
...
CROWDSTRIKE_REFRESH_TOKEN_ERROR = "Error while refreshing token"  # noqa: S105
CROWDSTRIKE_FROM_SERVER_ERROR = (
    "Error from Server, Status Code: {status}, Message: {message}"
)
...
CROWDSTRIKE_RESOURCES_KEY_EMPTY_ERROR = (
    "Resources key empty or not present. Please try after sometime"
)
CROWDSTRIKE_DATAFEED_EMPTY_ERROR = "Datafeed key empty or not present"
CROWDSTRIKE_SESSION_TOKEN_NOT_FOUND_ERROR = "Session token, not found"  # noqa: S105
...
CROWDSTRIKE_LIMIT_VALIDATION_ALLOW_ZERO_MESSAGE = (
    "Please provide zero or a valid positive integer value in the {parameter} parameter"
)
...
CROWDSTRIKE_MISSING_PARAMETER_MESSAGE_ERROR = (
    "Please either provide 'resource id' or 'indicator type' and 'indicator value'"
)
...
CROWDSTRIKE_UNICODE_DAMMIT_TYPE_MESSAGE_ERROR = "Error occurred while connecting to the Crowdstrike server. Please check the asset configuration and|or the action parameters."
CROWDSTRIKE_INVALID_QUERY_ENDPOINT_MESSAGE_ERROR = (
    "Invalid endpoint. The endpoint must be a query endpoint"
)
...
CROWDSTRIKE_REACHED_CR_LF_COUNT_MESSAGE = (
    "CR/LF received on iteration: {} - terminating loop"
)
...
CROWDSTRIKE_FILTER_GET_CUSTOM_IOC = (
    "(type:'{}' + value:'{}') + (deleted:'true', deleted: 'false')"
)
CROWDSTRIKE_FILTER_GET_CUSTOM_IOC_RESOURCE_ID = (
    "id:'{}' + (deleted:'true', deleted: 'false')"
)
...
CROWDSTRIKE_ERROR_INVALID_ACTION_PARAM = (
    "Please provide a valid value in the '{key}' parameter"
)
# endpoint
CROWDSTRIKE_OAUTH_TOKEN_ENDPOINT = "/oauth2/token"  # noqa: S105
...
CROWDSTRIKE_MISSING_PARAMETER_MESSAGE_DELETE_IOC_ERROR = (
    "Please provide at least one of the parameter"
)
